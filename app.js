...
const addCardComponent = (
  ...
  console.log(image, link, url, title);
  ...
  const cardElement = isExpired
    ...
    : `
      ...
      ? `<img
        ...
        <a href="${link}" target="_blank" rel="noopener" class="card__actions__button">Learn More</a>
      </div>`
      : ''
    }
        ...
        rel="noopener noreferrer" class="card__header__title">${title}</a>
          ...
          <p class="card__input" type="text" name="link" id="link" value="" hidden>${url || link
    }</p> 
